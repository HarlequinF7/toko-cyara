	...
	<section class="shop-services section">
		<div class="container">
			<div class="row">
				...
				<?php $setiap=$koneksi->query("SELECT * FROM halaman WHERE id ='$id'");
				$tiap=$setiap->fetch_assoc(); ?>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 15px">
					<h2 style=" border-bottom: 5px solid red; "><?php echo $tiap['halaman'] ?></h2>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" ><p><?php echo $tiap['isi'] ?></p></div>			
			</div>
		</div>
	</section>
	<!-- Start Product Area -->
